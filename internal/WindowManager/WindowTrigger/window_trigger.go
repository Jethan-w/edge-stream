...
type WindowTrigger interface {
	// RegisterWindow 注册窗口
	RegisterWindow(window windowmanager.Window) error
...
type TriggerStrategy interface {
	...
	ShouldTrigger(window windowmanager.Window, currentTime int64) bool
...
type OutputProcessor interface {
	// ProcessWindow 处理窗口
	ProcessWindow(window windowmanager.Window, aggregator aggregationcalculator.WindowAggregator) error
}
...
type StandardWindowTrigger struct {
	windows         map[string]windowmanager.Window
	strategy        TriggerStrategy
	outputProcessor OutputProcessor
	aggregator      aggregationcalculator.WindowAggregator
	ctx             context.Context
...
func NewStandardWindowTrigger() *StandardWindowTrigger {
	...
	return &StandardWindowTrigger{
		windows:       make(map[string]windowmanager.Window),
...
// RegisterWindow 注册窗口
func (swt *StandardWindowTrigger) RegisterWindow(window windowmanager.Window) error {
	swt.mu.Lock()
	defer swt.mu.Unlock()
...
// SetAggregator 设置聚合器
func (swt *StandardWindowTrigger) SetAggregator(aggregator aggregationcalculator.WindowAggregator) {
	swt.mu.Lock()
	defer swt.mu.Unlock()
...
// ShouldTrigger 判断是否应该触发
func (tts *TimeTriggerStrategy) ShouldTrigger(window windowmanager.Window, currentTime int64) bool {
...
// ShouldTrigger 判断是否应该触发
func (cts *CountTriggerStrategy) ShouldTrigger(window windowmanager.Window, currentTime int64) bool {
...
// ShouldTrigger 判断是否应该触发
func (mts *MixedTriggerStrategy) ShouldTrigger(window windowmanager.Window, currentTime int64) bool {
...
// ShouldTrigger 判断是否应该触发
func (mts *ManualTriggerStrategy) ShouldTrigger(window windowmanager.Window, currentTime int64) bool {
	mts.mu.RLock()
...
// ShouldTrigger 判断是否应该触发
func (wts *WatermarkTriggerStrategy) ShouldTrigger(window windowmanager.Window, currentTime int64) bool {
